...
public class LoadMapTest {
    ...
    @Autowired
    private SeaElementRepository<SeaElement>             seaElementSeaElementRepository;
    @Autowired
    ...
    public void setup() throws IOException {
        ...
        seaElementSeaElementRepository.deleteAll();
        // setup data for map
        ...
        var resourceConfig = new ResourceIslandConfig().setResourceCapacity(100.0).setId(2L);
        ...
        for (var e : data) {
            e.setCoordinate(e.getCoordinates());
            mapService.saveOrUpdateElement(new SaveOrUpdateElementCommand(e));
        }
    }

    @Test
    public void test_load_map_0_0_40_40() {
//        var elements = mapService.getElementsByArea(new GetElementsByAreaCommand(new Coordinates(0L, 0L), 40L, 40L));
